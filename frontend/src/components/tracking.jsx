  ...
  <div className="bg-gray-100 min-h-screen p-6">
    ...
    {loading ? (
      ...
      <div className="bg-white rounded-lg shadow-lg p-6 mb-6">
          ...
          <div className="bg-gray-50 p-4 rounded-lg">
            ...
            <div className="space-y-3">
              ...
              <div className="flex justify-between">
                ...
                <span className="font-medium">{formatDate(selectedPort.reported_at)}</span>
              </div>
            </div>
          </div>
        ...
        {/* Added Fault Statistics Section */}
            ...
            <div className="bg-white p-4 rounded-lg shadow-sm">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xl font-semibold">{selectedPort.lastDayFaultValue}</p>
                </div>
            ...
            <div className="bg-white p-4 rounded-lg shadow-sm">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xl font-semibold">{selectedPort.last7FaultValue}</p>
                </div>
            ...
            <div className="bg-white p-4 rounded-lg shadow-sm">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xl font-semibold">{selectedPort.last30FaultValue}</p>
                </div>
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {selectedPort.vehicle_charges.map((charge, index) => (
                  <tr key={index} className="hover:bg-gray-50">
                    ...
                    <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-500">{charge.session_id}</td>
                    ...
                    <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-500">{charge.charged_percent}%</td>
                    ...
                    <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-500">₹{charge.cost_per_percent}</td>
                  ...
                  <div className="p-4">
                    ...
                    <div className="space-y-3 mb-4">
                      ...
                      <div className="flex items-center">
                        ...
                        <span className="text-gray-600">Faults (7d): <span className="font-medium">{port.last7FaultValue}</span></span>
                      </div>
                    </div>
                ...
                <div className="flex justify-between items-center">
                  ...
                  <div className="flex items-center gap-6">
                    ...
                    <div>
                      ...
                      <p className="text-sm font-medium">{port.lastDayFaultValue}/{port.last7FaultValue}/{port.last30FaultValue}</p>
                    </div>
                    <div>
